    ...
    <div class="flex-1 overflow-y-auto px-4 py-5">
        ...
        <div class="mb-7">
            ...
            <nav class="space-y-1">
                ...
                <a href="<?= BASE_URL ?>/master/opinion-offices" class="<?= $navBase ?> <?= isActiveNav('master/opinion-offices', $currentRoute) ?>">
                    <svg class="h-5 w-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.8"
                              d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"/>
                    </svg>
                ...
                <a href="<?= BASE_URL ?>/master/opinion-statuses" class="<?= $navBase ?> <?= isActiveNav('master/opinion-statuses', $currentRoute) ?>">
                    <svg class="h-5 w-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.8"
                              d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/>
                    </svg>
